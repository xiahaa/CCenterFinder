...
_LIGHT = {
    'points': '#7fb3d5',    # light blue
    'dec': '#48c9b0',       # teal
    'joint': '#f8c471',     # light orange
...
def run_two_cases(save_path: str | None = None):
    ...
    _plot_compare(ax1, P1, C, r, n, 'Isotropic 3D noise')
    ax2 = fig.add_subplot(2, 2, 2, projection='3d')
    _plot_compare(ax2, P2, C, r, n, 'Limited span')
    ax3 = fig.add_subplot(2, 2, 3, projection='3d')
    _plot_compare(ax3, P3, C, r, n, 'Sparse non-uniform')
    ax4 = fig.add_subplot(2, 2, 4, projection='3d')
    _plot_compare(ax4, P4, C, r, n, 'Symmetric distribution with non-uniform intervals')
